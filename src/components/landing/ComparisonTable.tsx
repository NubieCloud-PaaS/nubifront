          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border-0">
                <th className="text-left py-3 px-4 text-text-tertiary font-medium">Critere</th>
                <th className="py-3 px-4 text-center font-semibold text-blue-500 bg-blue-500/5 rounded-t-lg">Nubiecloud</th>
                <th className="py-3 px-4 text-center text-text-tertiary font-medium">AWS</th>
                <th className="py-3 px-4 text-center text-text-tertiary font-medium">Heroku</th>
                <th className="py-3 px-4 text-center text-text-tertiary font-medium">Vercel</th>
              </tr>
            </thead>
            <tbody>
              {criteria.map((row) => (
                <tr key={row.label} className="border-b border-border-0/50">
                  ...
                  <td className="py-3 px-4 text-center bg-blue-500/5 font-medium text-text-primary">
                    <CellContent value={row.nubi} />
                  </td>
                  <td className="py-3 px-4 text-center text-text-tertiary">
