...
- **N'y mettez aucun secret.** Ces valeurs sont stockées en clair ; les applications managées n'ont pas de variables sensibles, contrairement aux applications déployées depuis votre code.
