...
> 📸 **Capture à fournir** — `quickstart/11-logs-monitoring.png` : la page de gestion d'un déploiement (`/deployment/:depId`) montrant l'onglet **Logs** (lignes de log en temps réel) puis l'onglet **Monitoring** (santé, pods, événements).
