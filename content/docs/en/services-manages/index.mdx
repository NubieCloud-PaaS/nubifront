...
description: Managed databases, middleware and applications (PostgreSQL, MySQL, Redis, RabbitMQ, Kafka, Keycloak, n8n, Metabase, Hasura, DocuSeal, Open WebUI) — how they work, and how to connect from your applications.
---
