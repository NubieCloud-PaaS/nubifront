...
description: Managed databases and middleware (PostgreSQL, MySQL, Redis, RabbitMQ, Kafka, Keycloak, n8n, Metabase) — how they work, and how to connect from your applications.
---
...
> ℹ️ **Three of these blocks are applications**, not services: **Keycloak**, **n8n** and **Metabase** open in a browser at a public URL, have no port to connect to, and keep their data in a managed PostgreSQL that stays yours.
