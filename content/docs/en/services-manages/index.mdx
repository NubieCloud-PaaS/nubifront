...
description: Managed databases, middleware and applications (PostgreSQL, MySQL, Redis, RabbitMQ, Kafka, Keycloak, n8n, Metabase, Hasura, DocuSeal) — how they work, and how to connect from your applications.
---
...
> ℹ️ **Five of these blocks are applications**, not services: **Keycloak**, **n8n**, **Metabase**, **Hasura** and **DocuSeal** open in a browser at a public URL, have no port to connect to, and keep their data in a managed PostgreSQL that stays yours. **DocuSeal** adds a [NubiS3](/docs/en/services-manages/reference#docuseal) bucket for its documents, created and deleted with it.
