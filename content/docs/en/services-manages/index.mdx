...
description: Managed databases and middleware (PostgreSQL, MySQL, MongoDB, Redis, RabbitMQ) — how they work, and how to connect from your applications.
---
...
| **[Keycloak](/en/docs/services-manages/keycloak)** | Identity, SSO (OIDC / SAML) | public URL | via its PostgreSQL | — |

> ℹ️ **PostgreSQL is the most complete service**: Blue/Green high availability, automatic backups to object storage, and a [built-in SQL console](/en/docs/services-manages/reference#sql-console). The other services are deployed as single instances.
