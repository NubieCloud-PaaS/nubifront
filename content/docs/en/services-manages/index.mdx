...
description: Managed databases, middleware and applications (PostgreSQL, MySQL, Redis, RabbitMQ, Kafka, Keycloak, n8n, Metabase, Hasura) — how they work, and how to connect from your applications.
---
...
> ℹ️ **Four of these blocks are applications**, not services: **Keycloak**, **n8n**, **Metabase** and **Hasura** open in a browser at a public URL, have no port to connect to, and keep their data in a managed PostgreSQL that stays yours.
