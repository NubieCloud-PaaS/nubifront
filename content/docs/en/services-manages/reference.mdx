...
- **Never put a secret there.** These values are stored in plain text; managed applications have no sensitive variables, unlike applications deployed from your code.
